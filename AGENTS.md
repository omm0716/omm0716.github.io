...
카테고리 페이지(`python.md`, `database.md`, `machine-learning.md`)는 모두 `sort: 'date'`를 사용하여 **날짜 오름차순(강좌 순서대로)** 표시합니다.
...
이 폴더는 "omm0716"님이 Python, Database, Machine Learning에 대한 프로그래밍 지식을 정리하고 공유하기 위해 운영 중인 개인 학습용 Jekyll 블로그 소스 코드입니다.
...
- **Key files**:
  ...
  - `python.md`, `database.md`, `machine-learning.md`: Category pages with ascending `sort: 'date'`

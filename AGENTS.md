...
| 2026-06-11 | **다국어 네이티브 번역 사전 고도화** (추천 위젯, 퀴즈 위젯, 사이드바, 네비게이션바 등 주요 UI 요소에 `data-i18n`를 활용한 4개국어 네이티브 클라이언트 번역 사전 구축 및 전환 즉시 무지연 반영 구현) |

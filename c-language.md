...
layout: page
title: C Language
subtitle: C언어 관련 모든 포스트를 모아둔 곳입니다. (This is a collection of all C Language-related posts.)
...
{% endcomment %}
{% assign c_posts = "" | split: "" %}
{% if site.categories["C-Language"] %}
  {% assign c_posts = site.categories["C-Language"] %}
{% elsif site.categories["c-language"] %}
  {% assign c_posts = site.categories["c-language"] %}
{% endif %}
{% assign c_posts = c_posts | sort: 'date' %}

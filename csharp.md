...
{% endcomment %}
{% assign csharp_posts = "" | split: "" %}
{% if site.categories["C-Sharp"] %}
  {% assign csharp_posts = site.categories["C-Sharp"] %}
{% elsif site.categories["c-sharp"] %}
  {% assign csharp_posts = site.categories["c-sharp"] %}
{% endif %}
{% assign csharp_posts = csharp_posts | sort: 'date' %}
